...
#' @param savegbm Save gbm objects? Open with load("Bin_Best_Model")
...
# explanatory variables. Default 1*white: white bars black borders. '1*' repeats
  ...
  savegbm = TRUE,       # save gbm objects? Open with load("Bin_Best_Model")
...
# for error "contrasts can be applied only to factors with 2 or more levels"
  ...
  mapshape = NULL,      # set coast shapefile, else downloaded & autogenerated
  ...
  ...)                  # optional arguments for gbm.map and gbm.step; mainlegendtitle sets map legend title, the metric of abundance
{
