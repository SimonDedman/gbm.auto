...
#' @param mapmain Plot title, has species value appended. Default "Predicted CPUE (numbers per hour): "
...
#' @param landcol Colour for 'null' area of map (for marine plots, this is land), from draw.shape in mapplots. Default "grey80" (light grey)
#' @param mapback Basemap background colour, defaults to lightblue (ocean for marine plots)
#' @param legendloc Location on map of legend box, from legend.grid in mapplots, default bottomright
#' @param legendtitle The metric of abundance, e.g. CPUE for fisheries, from legend.grid in mapplots. Default "CPUE"
#' @param lejback Background colour of legend, from legend.grid in mapplots. Default "white"
#' @param zero Force include 0-only bin in breaks.grid and thus legend? Default TRUE
#' @param quantile Set max quantile of data to include in bins, from breaks.grid in mapplots; lower to e.g. 0.975 cutoff outliers; default 1
