...
# as a function:
# levels param: default Alphabetical, other options Rising (see below), Falling (reverse, arrange(desc)), then user entry - detect a character vector & check it matches the Categorry entries
# save options?
