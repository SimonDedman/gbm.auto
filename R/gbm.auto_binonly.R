...
#' @param cols Barplot colour vector. Assignment in order of explanatory variables. Default 1*white: white bars black borders. '1*' repeats
#' @param linesfiles Save individual line plots' data as csv's?
#' @param savegbm Save gbm objects? Open w/ load("Bin_Best_Model")
#' @param varint Calculate variable interactions? Default:TRUE, FALSE for error "contrasts can be applied only to factors with 2 or more levels"
#' @param map Save abundance map png files?
#' @param mapshape Set coast shapefile, else downloaded & autogenerated
...
#' @param binonly Run only binomial sections of code?
