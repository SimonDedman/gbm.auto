gbm.map <- function(x,        # vector of longitudes, from make.grid in mapplots; grids[,gridslon]
                    ...
                    byx,      # longitudinal width of grid cell, from make.grid in mapplots. Autogenerated if left blank.
                    byy,      # latitudinal height of grid cell, from make.grid in mapplots. Autogenerated if left blank.
