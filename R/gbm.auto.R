...
#' @param ZI are data zero-inflated? TRUE FALSE "CHECK". TRUE: delta BRT, log-normalised Gaus, reverse log-norm and bias corrected. FALSE: do Gaussian only, no log-normalisation. CHECK: Tests data for you. Default is TRUE.
